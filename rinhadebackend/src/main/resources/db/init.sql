-- SQL init
-- rinhadebackend/src/main/resources/db/migration/V202402090620__rinha.sql
...
INSERT INTO clientes (nome, limite) VALUES
	...
	('kid mais', 5000 * 100);
-- rinhadebackend/src/main/resources/db/migration/V202402090621__transacao.sql
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        ROLLBACK;
END;
$$ LANGUAGE plpgsql;-- rinhadebackend/src/main/resources/db/migration/V202402122014__extrato.sql
...
BEGIN
    ...
    RETURN result;
END;
$$ LANGUAGE plpgsql;-- SQL init done
