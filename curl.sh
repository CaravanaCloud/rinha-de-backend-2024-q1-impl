...
curl -v -X GET http://localhost:9000/clientes/1/extrato
curl -v -X POST -H "Content-Type: application/json" -d '{"valor": 1, "tipo": "c", "descricao": "teste"}' http:///localhost:9000/clientes/1/transacoes
